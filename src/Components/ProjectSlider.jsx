        ...
        <button
          ...
          className={`w-2 h-2 rounded-full transition-all duration-300 ${
            index === current
              ...
              : 'bg-gray-600/40 border border-gray-500/30'
          }`}
        />
      ))}
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-30 left-20 w-72 h-72 bg-purple-600/10 rounded-full blur-3xl animate-blob" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
          <button
            ...
            className="group relative bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-4 px-8 text-lg font-semibold rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl "
          >
      ...
      <style jsx>{`
        .bg-grid-16 {
          background-image: radial-gradient(circle, rgba(212, 13, 13, 0.05) 1px, transparent 1px);
